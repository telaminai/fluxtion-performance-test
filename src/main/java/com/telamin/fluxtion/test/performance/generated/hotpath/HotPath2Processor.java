...
public class HotPath2Processor
    implements CloneableDataFlow<HotPath2Processor>,
        /*--- @ExportService start ---*/
  ...
  private final transient HotPathRootNode hotPathRootNode_4 = new HotPathRootNode();
  private final transient HotPathFilteringNode hotPathFilteringNode_3 = new HotPathFilteringNode();
  ...
  private boolean isDirty_hotPathAccumulatorNode_2 = false;
  private boolean isDirty_hotPathFilteringNode_3 = false;
  private boolean isDirty_hotPathFilteringNode_5 = false;
  private boolean isDirty_hotPathRootNode_4 = false;
  ...
  public HotPath2Processor(Map<Object, Object> contextMap) {
    if (context != null) {
      context.replaceMappings(contextMap);
    }
    context.setClock(clock);
    serviceRegistry.setDataFlowContext(context);
    hotPathAccumulatorNode_1.setUpstream1(hotPathFilteringNode_5);
    hotPathAccumulatorNode_1.value = 0.0;
    hotPathAccumulatorNode_1.upstream1 = hotPathFilteringNode_5;
    hotPathAccumulatorNode_2.setUpstream1(hotPathFilteringNode_3);
    hotPathAccumulatorNode_2.value = 0.0;
    hotPathAccumulatorNode_2.upstream1 = hotPathFilteringNode_3;
    hotPathFilteringNode_3.setUpstream1(hotPathRootNode_4);
    hotPathFilteringNode_3.value = 0.0;
    hotPathFilteringNode_3.upstream1 = hotPathRootNode_4;
    hotPathFilteringNode_5.setUpstream1(hotPathRootNode_4);
    hotPathFilteringNode_5.value = 0.0;
    hotPathFilteringNode_5.upstream1 = hotPathRootNode_4;
    sink.setUpstream1(hotPathAccumulatorNode_2);
    sink.upstream1 = hotPathAccumulatorNode_2;
    sink.value = 0.0;
    hotPathRootNode_4.value = 0.0;
    //node auditors
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_hotPathRootNode_4 = hotPathRootNode_4.onMarketData(typedEvent);
    if (guardCheck_hotPathFilteringNode_3()) {
      isDirty_hotPathFilteringNode_3 = hotPathFilteringNode_3.onUpstream();
    }
    if (guardCheck_hotPathAccumulatorNode_2()) {
      isDirty_hotPathAccumulatorNode_2 = hotPathAccumulatorNode_2.onUpstream();
    }
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(hotPathFilteringNode_3, "hotPathFilteringNode_3");
    auditor.nodeRegistered(hotPathFilteringNode_5, "hotPathFilteringNode_5");
    auditor.nodeRegistered(sink, "sink");
    auditor.nodeRegistered(hotPathRootNode_4, "hotPathRootNode_4");
  }
  ...
  private void afterEvent() {
    ...
    isDirty_hotPathAccumulatorNode_2 = false;
    isDirty_hotPathFilteringNode_3 = false;
    isDirty_hotPathFilteringNode_5 = false;
    isDirty_hotPathRootNode_4 = false;
  }
  ...
  public BooleanSupplier dirtySupplier(Object node) {
    if (dirtyFlagSupplierMap.isEmpty()) {
      dirtyFlagSupplierMap.put(hotPathAccumulatorNode_2, () -> isDirty_hotPathAccumulatorNode_2);
      dirtyFlagSupplierMap.put(hotPathFilteringNode_3, () -> isDirty_hotPathFilteringNode_3);
      dirtyFlagSupplierMap.put(hotPathFilteringNode_5, () -> isDirty_hotPathFilteringNode_5);
      dirtyFlagSupplierMap.put(hotPathRootNode_4, () -> isDirty_hotPathRootNode_4);
    }
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      dirtyFlagUpdateMap.put(hotPathAccumulatorNode_2, (b) -> isDirty_hotPathAccumulatorNode_2 = b);
      dirtyFlagUpdateMap.put(hotPathFilteringNode_3, (b) -> isDirty_hotPathFilteringNode_3 = b);
      dirtyFlagUpdateMap.put(hotPathFilteringNode_5, (b) -> isDirty_hotPathFilteringNode_5 = b);
      dirtyFlagUpdateMap.put(hotPathRootNode_4, (b) -> isDirty_hotPathRootNode_4 = b);
    }
  ...
  private boolean guardCheck_hotPathAccumulatorNode_2() {
    return isDirty_hotPathFilteringNode_3;
  }

  private boolean guardCheck_hotPathFilteringNode_3() {
    return isDirty_hotPathRootNode_4;
  }
  ...
  private boolean guardCheck_sink() {
    return isDirty_hotPathAccumulatorNode_2;
  }
  ...
  @Override
  public HotPath2Processor newInstance() {
    return new HotPath2Processor();
  }

  @Override
  public HotPath2Processor newInstance(Map<Object, Object> contextMap) {
    return new HotPath2Processor();
  }
