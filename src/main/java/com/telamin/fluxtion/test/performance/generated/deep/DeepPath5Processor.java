...
public class DeepPath5Processor
    implements CloneableDataFlow<DeepPath5Processor>,
        /*--- @ExportService start ---*/
  ...
  private final transient RootLinearNode rootLinearNode_6 = new RootLinearNode();
  ...
  public DeepPath5Processor(Map<Object, Object> contextMap) {
    if (context != null) {
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    rootLinearNode_6.onMarketData(typedEvent);
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(rootLinearNode_6, "rootLinearNode_6");
  }
  ...
  @Override
  public DeepPath5Processor newInstance() {
    return new DeepPath5Processor();
  }

  @Override
  public DeepPath5Processor newInstance(Map<Object, Object> contextMap) {
    return new DeepPath5Processor();
  }
