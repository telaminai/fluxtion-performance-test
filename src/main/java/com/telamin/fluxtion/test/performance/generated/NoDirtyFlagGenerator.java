...
public class NoDirtyFlagGenerator
    implements CloneableDataFlow<NoDirtyFlagGenerator>,
        /*--- @ExportService start ---*/
  ...
  private final transient RootLinearNode rootLinearNode_2 = new RootLinearNode();
  ...
  public NoDirtyFlagGenerator(Map<Object, Object> contextMap) {
    if (context != null) {
    ...
    linearNode_1.setNodeId("linear");
    linearNode_1.setUpstream1(rootLinearNode_2);
    linearNode_1.value = 0.0;
    rootLinearNode_2.setNodeId("linear");
    rootLinearNode_2.value = 0.0;
    //node auditors
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    rootLinearNode_2.onMarketData(typedEvent);
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(rootLinearNode_2, "rootLinearNode_2");
  }
  ...
  @Override
  public NoDirtyFlagGenerator newInstance() {
    return new NoDirtyFlagGenerator();
  }

  @Override
  public NoDirtyFlagGenerator newInstance(Map<Object, Object> contextMap) {
    return new NoDirtyFlagGenerator();
  }
