...
public class NoopDispatch5Processor
    implements CloneableDataFlow<NoopDispatch5Processor>,
        /*--- @ExportService start ---*/
  ...
  private final transient MarketDataRootNode marketDataRootNode_6 = new MarketDataRootNode();
  ...
  public NoopDispatch5Processor(Map<Object, Object> contextMap) {
    ...
    marketDataRootNode_6.setNodeId("root");
    noOpNode_1.setNodeId("node_5");
    noOpNode_1.setUpstream1(noOpNode_2);
    noOpNode_2.setNodeId("node_4");
    noOpNode_2.setUpstream1(noOpNode_3);
    noOpNode_3.setNodeId("node_3");
    noOpNode_3.setUpstream1(noOpNode_4);
    noOpNode_4.setNodeId("node_2");
    noOpNode_4.setUpstream1(noOpNode_5);
    noOpNode_5.setNodeId("node_1");
    noOpNode_5.setUpstream1(marketDataRootNode_6);
    sink.setNodeId("sink");
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    marketDataRootNode_6.onMarketData(typedEvent);
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(marketDataRootNode_6, "marketDataRootNode_6");
