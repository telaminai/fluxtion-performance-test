...
public class ShortChain10Processor
  ...
  public final transient ShortChainNode node_6 = new ShortChainNode();
  public final transient ShortChainNode node_7 = new ShortChainNode();
  public final transient ShortChainNode node_8 = new ShortChainNode();
  public final transient ShortChainNode node_9 = new ShortChainNode();
  public final transient ShortChainNode node_10 = new ShortChainNode();
  ...
  public ShortChain10Processor(Map<Object, Object> contextMap) {
    ...
    node_6.setNodeId("sc_node");
    node_6.setUpstream1(node_5);
    node_7.setNodeId("sc_node");
    node_7.setUpstream1(node_6);
    node_8.setNodeId("sc_node");
    node_8.setUpstream1(node_7);
    node_9.setNodeId("sc_node");
    node_9.setUpstream1(node_8);
    node_10.setNodeId("sc_node");
  ...
  public void handleEvent(ShortChainEvent typedEvent) {
    ...
    if (guardCheck_node_6()) {
      isDirty_node_6 = node_6.onUpstream();
    }
    if (guardCheck_node_7()) {
      isDirty_node_7 = node_7.onUpstream();
    }
    if (guardCheck_node_8()) {
      isDirty_node_8 = node_8.onUpstream();
    }
    if (guardCheck_node_9()) {
      isDirty_node_9 = node_9.onUpstream();
    }
    if (guardCheck_node_10()) {
      isDirty_node_10 = node_10.onUpstream();
    }
    if (guardCheck_sink()) {
      sink.onUpstream();
    }
