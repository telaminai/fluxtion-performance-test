...
public class NoopDispatch20Processor
  ...
  private final transient RootNoOpNode rootNoOpNode_21 = new RootNoOpNode();
  ...
  public NoopDispatch20Processor(Map<Object, Object> contextMap) {
    ...
    noOpNode_20.setUpstream1(rootNoOpNode_21);
    noOpNode_20.value = 0.0;
    noOpNode_20.upstream1 = rootNoOpNode_21;
    sink.setUpstream1(noOpNode_1);
    sink.upstream1 = noOpNode_1;
    sink.value = 0.0;
    rootNoOpNode_21.value = 0.0;
    //node auditors
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    rootNoOpNode_21.onMarketData(typedEvent);
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(rootNoOpNode_21, "rootNoOpNode_21");
  }
