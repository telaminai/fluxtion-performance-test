...
public class NoopDispatch10Processor
  ...
  private final transient MarketDataRootNode marketDataRootNode_11 = new MarketDataRootNode();
  ...
  public NoopDispatch10Processor(Map<Object, Object> contextMap) {
    ...
    marketDataRootNode_11.setNodeId("root");
    noOpNode_1.setNodeId("node_10");
    noOpNode_1.setUpstream1(noOpNode_2);
    noOpNode_2.setNodeId("node_9");
    noOpNode_2.setUpstream1(noOpNode_3);
    noOpNode_3.setNodeId("node_8");
    noOpNode_3.setUpstream1(noOpNode_4);
    noOpNode_4.setNodeId("node_7");
    noOpNode_4.setUpstream1(noOpNode_5);
    noOpNode_5.setNodeId("node_6");
    noOpNode_5.setUpstream1(noOpNode_6);
    noOpNode_6.setNodeId("node_5");
    noOpNode_6.setUpstream1(noOpNode_7);
    noOpNode_7.setNodeId("node_4");
    noOpNode_7.setUpstream1(noOpNode_8);
    noOpNode_8.setNodeId("node_3");
    noOpNode_8.setUpstream1(noOpNode_9);
    noOpNode_9.setNodeId("node_2");
    noOpNode_9.setUpstream1(noOpNode_10);
    noOpNode_10.setNodeId("node_1");
    noOpNode_10.setUpstream1(marketDataRootNode_11);
    sink.setNodeId("sink");
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    marketDataRootNode_11.onMarketData(typedEvent);
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(marketDataRootNode_11, "marketDataRootNode_11");
