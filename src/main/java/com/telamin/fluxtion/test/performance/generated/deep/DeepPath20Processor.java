...
public class DeepPath20Processor
    implements CloneableDataFlow<DeepPath20Processor>,
        /*--- @ExportService start ---*/
  ...
  private final transient RootLinearNode rootLinearNode_21 = new RootLinearNode();
  ...
  public DeepPath20Processor(Map<Object, Object> contextMap) {
    if (context != null) {
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    rootLinearNode_21.onMarketData(typedEvent);
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(rootLinearNode_21, "rootLinearNode_21");
  }
  ...
  @Override
  public DeepPath20Processor newInstance() {
    return new DeepPath20Processor();
  }

  @Override
  public DeepPath20Processor newInstance(Map<Object, Object> contextMap) {
    return new DeepPath20Processor();
  }
