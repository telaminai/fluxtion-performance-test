...
public class IntermediateHandlers10Processor
    implements CloneableDataFlow<IntermediateHandlers10Processor>,
        /*--- @ExportService start ---*/
  ...
  private final transient IntermediateHandlersRootNode intermediateHandlersRootNode_11 =
  ...
  private boolean isDirty_intermediateHandlersRootNode_11 = false;
  ...
  public IntermediateHandlers10Processor(Map<Object, Object> contextMap) {
    if (context != null) {
    ...
    intermediateHandlersNode_10.setUpstream1(intermediateHandlersRootNode_11);
    intermediateHandlersNode_10.value = 0.0;
    intermediateHandlersNode_10.upstream1 = intermediateHandlersRootNode_11;
    sink.setUpstream1(intermediateHandlersNode_1);
    sink.upstream1 = intermediateHandlersNode_1;
    sink.value = 0.0;
    intermediateHandlersRootNode_11.value = 0.0;
    //node auditors
  ...
  public IntermediateHandlers10Processor() {
    this(null);
  }
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_intermediateHandlersRootNode_11 =
        intermediateHandlersRootNode_11.onMarketData(typedEvent);
  ...
  public void handleEvent(TradeSignalEvent typedEvent) {
    ...
    //Default, no filter methods
    isDirty_intermediateHandlersRootNode_11 =
        intermediateHandlersRootNode_11.onTradeSignal(typedEvent);
    commonDispatchTail_1(typedEvent);
    afterEvent();
  }
  //EVENT DISPATCH - END
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(intermediateHandlersRootNode_11, "intermediateHandlersRootNode_11");
  }
  ...
  private void afterEvent() {
    ...
    isDirty_intermediateHandlersRootNode_11 = false;
  }
  ...
  public BooleanSupplier dirtySupplier(Object node) {
    if (dirtyFlagSupplierMap.isEmpty()) {
      ...
      dirtyFlagSupplierMap.put(
          intermediateHandlersRootNode_11, () -> isDirty_intermediateHandlersRootNode_11);
    }
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      ...
      dirtyFlagUpdateMap.put(
          intermediateHandlersRootNode_11, (b) -> isDirty_intermediateHandlersRootNode_11 = b);
    }
  ...
  private boolean guardCheck_intermediateHandlersNode_10() {
    return isDirty_intermediateHandlersRootNode_11;
  }
  ...
  @Override
  public IntermediateHandlers10Processor newInstance() {
    return new IntermediateHandlers10Processor();
  }

  @Override
  public IntermediateHandlers10Processor newInstance(Map<Object, Object> contextMap) {
    return new IntermediateHandlers10Processor();
  }
