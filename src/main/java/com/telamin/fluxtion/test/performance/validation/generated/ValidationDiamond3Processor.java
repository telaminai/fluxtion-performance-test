...
public class ValidationDiamond3Processor
  ...
  private final transient DataCollector dataCollector_29 = new DataCollector();
  private final transient EventContext eventContext_28 = new EventContext();
  ...
  public ValidationDiamond3Processor(Map<Object, Object> contextMap) {
    ...
    ts_l1_n0.setDataCollector(dataCollector_29);
    ts_l1_n0.setEventContext(eventContext_28);
    ts_l1_n0.value = 0.0;
    ts_l1_n0.nodeId = "ts_l1_n0";
    ts_l1_n0.eventContext = eventContext_28;
    ts_l1_n0.dataCollector = dataCollector_29;
    ts_l1_n0.upstream1 = ts_root;
    ts_l1_n1.setUpstream1(ts_root);
    ts_l1_n1.setNodeId("ts_l1_n1");
    ts_l1_n1.setDataCollector(dataCollector_29);
    ts_l1_n1.setEventContext(eventContext_28);
    ts_l1_n1.value = 0.0;
    ts_l1_n1.nodeId = "ts_l1_n1";
    ts_l1_n1.eventContext = eventContext_28;
    ts_l1_n1.dataCollector = dataCollector_29;
    ts_l1_n1.upstream1 = ts_root;
    ts_l1_n2.setUpstream1(ts_root);
    ts_l1_n2.setNodeId("ts_l1_n2");
    ts_l1_n2.setDataCollector(dataCollector_29);
    ts_l1_n2.setEventContext(eventContext_28);
    ts_l1_n2.value = 0.0;
    ts_l1_n2.nodeId = "ts_l1_n2";
    ts_l1_n2.eventContext = eventContext_28;
    ts_l1_n2.dataCollector = dataCollector_29;
    ts_l1_n2.upstream1 = ts_root;
    ts_l2_n0.setUpstream1(ts_l1_n0);
    ts_l2_n0.setNodeId("ts_l2_n0");
    ts_l2_n0.setDataCollector(dataCollector_29);
    ts_l2_n0.setEventContext(eventContext_28);
    ts_l2_n0.setUpstream2(ts_l1_n1);
    ts_l2_n0.value = 0.0;
    ts_l2_n0.nodeId = "ts_l2_n0";
    ts_l2_n0.eventContext = eventContext_28;
    ts_l2_n0.dataCollector = dataCollector_29;
    ts_l2_n0.upstream1 = ts_l1_n0;
    ts_l2_n0.upstream2 = ts_l1_n1;
    ts_l2_n1.setUpstream1(ts_l1_n1);
    ts_l2_n1.setNodeId("ts_l2_n1");
    ts_l2_n1.setDataCollector(dataCollector_29);
    ts_l2_n1.setEventContext(eventContext_28);
    ts_l2_n1.setUpstream2(ts_l1_n2);
    ts_l2_n1.value = 0.0;
    ts_l2_n1.nodeId = "ts_l2_n1";
    ts_l2_n1.eventContext = eventContext_28;
    ts_l2_n1.dataCollector = dataCollector_29;
    ts_l2_n1.upstream1 = ts_l1_n1;
    ts_l2_n1.upstream2 = ts_l1_n2;
    ts_l2_n2.setUpstream1(ts_l1_n2);
    ts_l2_n2.setNodeId("ts_l2_n2");
    ts_l2_n2.setDataCollector(dataCollector_29);
    ts_l2_n2.setEventContext(eventContext_28);
    ts_l2_n2.setUpstream2(ts_l1_n0);
    ts_l2_n2.value = 0.0;
    ts_l2_n2.nodeId = "ts_l2_n2";
    ts_l2_n2.eventContext = eventContext_28;
    ts_l2_n2.dataCollector = dataCollector_29;
    ts_l2_n2.upstream1 = ts_l1_n2;
    ts_l2_n2.upstream2 = ts_l1_n0;
    ctrl_l1_n0.setUpstream1(ctrl_root);
    ctrl_l1_n0.setNodeId("ctrl_l1_n0");
    ctrl_l1_n0.setDataCollector(dataCollector_29);
    ctrl_l1_n0.setEventContext(eventContext_28);
    ctrl_l1_n0.value = 0.0;
    ctrl_l1_n0.nodeId = "ctrl_l1_n0";
    ctrl_l1_n0.eventContext = eventContext_28;
    ctrl_l1_n0.dataCollector = dataCollector_29;
    ctrl_l1_n0.upstream1 = ctrl_root;
    ctrl_l1_n1.setUpstream1(ctrl_root);
    ctrl_l1_n1.setNodeId("ctrl_l1_n1");
    ctrl_l1_n1.setDataCollector(dataCollector_29);
    ctrl_l1_n1.setEventContext(eventContext_28);
    ctrl_l1_n1.value = 0.0;
    ctrl_l1_n1.nodeId = "ctrl_l1_n1";
    ctrl_l1_n1.eventContext = eventContext_28;
    ctrl_l1_n1.dataCollector = dataCollector_29;
    ctrl_l1_n1.upstream1 = ctrl_root;
    ctrl_l1_n2.setUpstream1(ctrl_root);
    ctrl_l1_n2.setNodeId("ctrl_l1_n2");
    ctrl_l1_n2.setDataCollector(dataCollector_29);
    ctrl_l1_n2.setEventContext(eventContext_28);
    ctrl_l1_n2.value = 0.0;
    ctrl_l1_n2.nodeId = "ctrl_l1_n2";
    ctrl_l1_n2.eventContext = eventContext_28;
    ctrl_l1_n2.dataCollector = dataCollector_29;
    ctrl_l1_n2.upstream1 = ctrl_root;
    ctrl_l2_n0.setUpstream1(ctrl_l1_n0);
    ctrl_l2_n0.setNodeId("ctrl_l2_n0");
    ctrl_l2_n0.setDataCollector(dataCollector_29);
    ctrl_l2_n0.setEventContext(eventContext_28);
    ctrl_l2_n0.value = 0.0;
    ctrl_l2_n0.nodeId = "ctrl_l2_n0";
    ctrl_l2_n0.eventContext = eventContext_28;
    ctrl_l2_n0.dataCollector = dataCollector_29;
    ctrl_l2_n0.upstream1 = ctrl_l1_n0;
    ctrl_l2_n1.setUpstream1(ctrl_l1_n1);
    ctrl_l2_n1.setNodeId("ctrl_l2_n1");
    ctrl_l2_n1.setDataCollector(dataCollector_29);
    ctrl_l2_n1.setEventContext(eventContext_28);
    ctrl_l2_n1.value = 0.0;
    ctrl_l2_n1.nodeId = "ctrl_l2_n1";
    ctrl_l2_n1.eventContext = eventContext_28;
    ctrl_l2_n1.dataCollector = dataCollector_29;
    ctrl_l2_n1.upstream1 = ctrl_l1_n1;
    ctrl_l2_n2.setUpstream1(ctrl_l1_n2);
    ctrl_l2_n2.setNodeId("ctrl_l2_n2");
    ctrl_l2_n2.setDataCollector(dataCollector_29);
    ctrl_l2_n2.setEventContext(eventContext_28);
    ctrl_l2_n2.value = 0.0;
    ctrl_l2_n2.nodeId = "ctrl_l2_n2";
    ctrl_l2_n2.eventContext = eventContext_28;
    ctrl_l2_n2.dataCollector = dataCollector_29;
    ctrl_l2_n2.upstream1 = ctrl_l1_n2;
    ctrl_sink.setUpstream1(ctrl_l2_n0);
    ctrl_sink.setNodeId("ctrl_sink");
    ctrl_sink.setDataCollector(dataCollector_29);
    ctrl_sink.setEventContext(eventContext_28);
    ctrl_sink.setUpstream2(ctrl_l2_n1);
    ctrl_sink.setUpstream3(ctrl_l2_n2);
    ctrl_sink.value = 0.0;
    ctrl_sink.nodeId = "ctrl_sink";
    ctrl_sink.eventContext = eventContext_28;
    ctrl_sink.dataCollector = dataCollector_29;
    ctrl_sink.upstream1 = ctrl_l2_n0;
    ctrl_sink.upstream2 = ctrl_l2_n1;
    ctrl_sink.upstream3 = ctrl_l2_n2;
    md_l1_n0.setUpstream1(md_root);
    md_l1_n0.setNodeId("md_l1_n0");
    md_l1_n0.setDataCollector(dataCollector_29);
    md_l1_n0.setEventContext(eventContext_28);
    md_l1_n0.value = 0.0;
    md_l1_n0.nodeId = "md_l1_n0";
    md_l1_n0.eventContext = eventContext_28;
    md_l1_n0.dataCollector = dataCollector_29;
    md_l1_n0.upstream1 = md_root;
    md_l1_n1.setUpstream1(md_root);
    md_l1_n1.setNodeId("md_l1_n1");
    md_l1_n1.setDataCollector(dataCollector_29);
    md_l1_n1.setEventContext(eventContext_28);
    md_l1_n1.value = 0.0;
    md_l1_n1.nodeId = "md_l1_n1";
    md_l1_n1.eventContext = eventContext_28;
    md_l1_n1.dataCollector = dataCollector_29;
    md_l1_n1.upstream1 = md_root;
    md_l1_n2.setUpstream1(md_root);
    md_l1_n2.setNodeId("md_l1_n2");
    md_l1_n2.setDataCollector(dataCollector_29);
    md_l1_n2.setEventContext(eventContext_28);
    md_l1_n2.value = 0.0;
    md_l1_n2.nodeId = "md_l1_n2";
    md_l1_n2.eventContext = eventContext_28;
    md_l1_n2.dataCollector = dataCollector_29;
    md_l1_n2.upstream1 = md_root;
    md_l2_n0.setUpstream1(md_l1_n0);
    md_l2_n0.setNodeId("md_l2_n0");
    md_l2_n0.setDataCollector(dataCollector_29);
    md_l2_n0.setEventContext(eventContext_28);
    md_l2_n0.setUpstream2(md_l1_n1);
    md_l2_n0.value = 0.0;
    md_l2_n0.nodeId = "md_l2_n0";
    md_l2_n0.eventContext = eventContext_28;
    md_l2_n0.dataCollector = dataCollector_29;
    md_l2_n0.upstream1 = md_l1_n0;
    md_l2_n0.upstream2 = md_l1_n1;
    md_l2_n1.setUpstream1(md_l1_n1);
    md_l2_n1.setNodeId("md_l2_n1");
    md_l2_n1.setDataCollector(dataCollector_29);
    md_l2_n1.setEventContext(eventContext_28);
    md_l2_n1.setUpstream2(md_l1_n2);
    md_l2_n1.value = 0.0;
    md_l2_n1.nodeId = "md_l2_n1";
    md_l2_n1.eventContext = eventContext_28;
    md_l2_n1.dataCollector = dataCollector_29;
    md_l2_n1.upstream1 = md_l1_n1;
    md_l2_n1.upstream2 = md_l1_n2;
    md_l2_n2.setUpstream1(md_l1_n2);
    md_l2_n2.setNodeId("md_l2_n2");
    md_l2_n2.setDataCollector(dataCollector_29);
    md_l2_n2.setEventContext(eventContext_28);
    md_l2_n2.setUpstream2(md_l1_n0);
    md_l2_n2.value = 0.0;
    md_l2_n2.nodeId = "md_l2_n2";
    md_l2_n2.eventContext = eventContext_28;
    md_l2_n2.dataCollector = dataCollector_29;
    md_l2_n2.upstream1 = md_l1_n2;
    md_l2_n2.upstream2 = md_l1_n0;
    md_l3_n0.setUpstream1(md_l2_n0);
    md_l3_n0.setNodeId("md_l3_n0");
    md_l3_n0.setDataCollector(dataCollector_29);
    md_l3_n0.setEventContext(eventContext_28);
    md_l3_n0.setUpstream2(md_l2_n1);
    md_l3_n0.value = 0.0;
    md_l3_n0.nodeId = "md_l3_n0";
    md_l3_n0.eventContext = eventContext_28;
    md_l3_n0.dataCollector = dataCollector_29;
    md_l3_n0.upstream1 = md_l2_n0;
    md_l3_n0.upstream2 = md_l2_n1;
    md_l3_n1.setUpstream1(md_l2_n1);
    md_l3_n1.setNodeId("md_l3_n1");
    md_l3_n1.setDataCollector(dataCollector_29);
    md_l3_n1.setEventContext(eventContext_28);
    md_l3_n1.setUpstream2(md_l2_n2);
    md_l3_n1.value = 0.0;
    md_l3_n1.nodeId = "md_l3_n1";
    md_l3_n1.eventContext = eventContext_28;
    md_l3_n1.dataCollector = dataCollector_29;
    md_l3_n1.upstream1 = md_l2_n1;
    md_l3_n1.upstream2 = md_l2_n2;
    md_l3_n2.setUpstream1(md_l2_n2);
    md_l3_n2.setNodeId("md_l3_n2");
    md_l3_n2.setDataCollector(dataCollector_29);
    md_l3_n2.setEventContext(eventContext_28);
    md_l3_n2.setUpstream2(md_l2_n0);
    md_l3_n2.value = 0.0;
    md_l3_n2.nodeId = "md_l3_n2";
    md_l3_n2.eventContext = eventContext_28;
    md_l3_n2.dataCollector = dataCollector_29;
    md_l3_n2.upstream1 = md_l2_n2;
    md_l3_n2.upstream2 = md_l2_n0;
    ctrl_root.setNodeId("ctrl_root");
    ctrl_root.setDataCollector(dataCollector_29);
    ctrl_root.setEventContext(eventContext_28);
    ctrl_root.value = 0.0;
    ctrl_root.nodeId = "ctrl_root";
    ctrl_root.eventContext = eventContext_28;
    ctrl_root.dataCollector = dataCollector_29;
    md_root.setNodeId("md_root");
    md_root.setDataCollector(dataCollector_29);
    md_root.setEventContext(eventContext_28);
    md_root.value = 0.0;
    md_root.nodeId = "md_root";
    md_root.eventContext = eventContext_28;
    md_root.dataCollector = dataCollector_29;
    md_sink.setUpstream1(md_l3_n0);
    md_sink.setNodeId("md_sink");
    md_sink.setDataCollector(dataCollector_29);
    md_sink.setEventContext(eventContext_28);
    md_sink.setUpstream2(md_l3_n1);
    md_sink.setUpstream3(md_l3_n2);
    md_sink.value = 0.0;
    md_sink.nodeId = "md_sink";
    md_sink.eventContext = eventContext_28;
    md_sink.dataCollector = dataCollector_29;
    md_sink.upstream1 = md_l3_n0;
    md_sink.upstream2 = md_l3_n1;
    md_sink.upstream3 = md_l3_n2;
    sink.setUpstream1(md_sink);
    sink.setNodeId("sink");
    sink.setDataCollector(dataCollector_29);
    sink.setEventContext(eventContext_28);
    sink.setUpstream2(ts_sink);
    sink.value = 0.0;
    sink.nodeId = "sink";
    sink.eventContext = eventContext_28;
    sink.dataCollector = dataCollector_29;
    sink.upstream1 = md_sink;
    sink.upstream2 = ts_sink;
    ts_sink.setUpstream1(ts_l2_n0);
    ts_sink.setNodeId("ts_sink");
    ts_sink.setDataCollector(dataCollector_29);
    ts_sink.setEventContext(eventContext_28);
    ts_sink.setUpstream2(ts_l2_n1);
    ts_sink.setUpstream3(ts_l2_n2);
    ts_sink.value = 0.0;
    ts_sink.nodeId = "ts_sink";
    ts_sink.eventContext = eventContext_28;
    ts_sink.dataCollector = dataCollector_29;
    ts_sink.upstream1 = ts_l2_n0;
    ts_sink.upstream2 = ts_l2_n1;
    ts_sink.upstream3 = ts_l2_n2;
    ts_root.setNodeId("ts_root");
    ts_root.setDataCollector(dataCollector_29);
    ts_root.setEventContext(eventContext_28);
    ts_root.value = 0.0;
    ts_root.nodeId = "ts_root";
    ts_root.eventContext = eventContext_28;
    ts_root.dataCollector = dataCollector_29;
    //node auditors
  ...
  public void init() {
    ...
    isDirty("test");
    clock.init();
    dataCollector_29.onInit();
    eventContext_28.onInit();
    afterEvent();
  }
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(dataCollector_29, "dataCollector_29");
    auditor.nodeRegistered(eventContext_28, "eventContext_28");
  ...
  private boolean guardCheck_ctrl_sink() {
    return isDirty_ctrl_l2_n0 | isDirty_ctrl_l2_n1 | isDirty_ctrl_l2_n2;
  }
  ...
  private boolean guardCheck_md_sink() {
    return isDirty_md_l3_n0 | isDirty_md_l3_n1 | isDirty_md_l3_n2;
  }
  ...
  private boolean guardCheck_ts_sink() {
    return isDirty_ts_l2_n0 | isDirty_ts_l2_n1 | isDirty_ts_l2_n2;
  }
