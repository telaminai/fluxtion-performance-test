...
public class ShortChain3Processor
    implements CloneableDataFlow<ShortChain3Processor>,
        /*--- @ExportService start ---*/
  ...
  private final transient ShortChainRootNode shortChainRootNode_4 = new ShortChainRootNode();
  ...
  private boolean isDirty_shortChainRootNode_4 = false;
  ...
  public ShortChain3Processor(Map<Object, Object> contextMap) {
    if (context != null) {
    ...
    shortChainNode_3.setUpstream1(shortChainRootNode_4);
    shortChainNode_3.value = 0.0;
    shortChainNode_3.upstream1 = shortChainRootNode_4;
    shortChainRootNode_4.value = 0.0;
  ...
  public void handleEvent(ShortChainEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_shortChainRootNode_4 = shortChainRootNode_4.processChain(typedEvent);
  ...
  public boolean processChain(com.telamin.fluxtion.test.performance.events.ShortChainEvent arg0) {
    ...
    isDirty_shortChainRootNode_4 = shortChainRootNode_4.processChain(arg0);
    if (guardCheck_shortChainNode_3()) {
      isDirty_shortChainNode_3 = shortChainNode_3.onUpstream();
    }
    if (guardCheck_shortChainNode_2()) {
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(shortChainRootNode_4, "shortChainRootNode_4");
  ...
  private void afterEvent() {
    ...
    isDirty_shortChainRootNode_4 = false;
  }
  ...
  public BooleanSupplier dirtySupplier(Object node) {
    if (dirtyFlagSupplierMap.isEmpty()) {
      ...
      dirtyFlagSupplierMap.put(shortChainRootNode_4, () -> isDirty_shortChainRootNode_4);
    }
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      ...
      dirtyFlagUpdateMap.put(shortChainRootNode_4, (b) -> isDirty_shortChainRootNode_4 = b);
    }
  ...
  private boolean guardCheck_shortChainNode_3() {
    return isDirty_shortChainRootNode_4;
  }
  ...
  @Override
  public ShortChain3Processor newInstance() {
    return new ShortChain3Processor();
  }

  @Override
  public ShortChain3Processor newInstance(Map<Object, Object> contextMap) {
    return new ShortChain3Processor();
  }
