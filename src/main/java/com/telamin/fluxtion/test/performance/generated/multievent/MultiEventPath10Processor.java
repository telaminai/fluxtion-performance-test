...
public class MultiEventPath10Processor
  ...
  private final transient MultiEventPathRootNode multiEventPathRootNode_11 =
  ...
  private boolean isDirty_multiEventPathRootNode_11 = false;
  ...
  public MultiEventPath10Processor(Map<Object, Object> contextMap) {
    ...
    multiEventPathNode_10.setUpstream1(multiEventPathRootNode_11);
    multiEventPathNode_10.value = 0.0;
    multiEventPathNode_10.upstream1 = multiEventPathRootNode_11;
    sink.setUpstream1(multiEventPathNode_1);
    sink.upstream1 = multiEventPathNode_1;
    sink.value = 0.0;
    multiEventPathRootNode_11.value = 0.0;
    //node auditors
  ...
  public void handleEvent(ControlEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_multiEventPathRootNode_11 = multiEventPathRootNode_11.onControl(typedEvent);
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_multiEventPathRootNode_11 = multiEventPathRootNode_11.onMarketData(typedEvent);
    commonDispatchTail_1(typedEvent);
    afterEvent();
  }
  ...
  public void handleEvent(TradeSignalEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_multiEventPathRootNode_11 = multiEventPathRootNode_11.onTradeSignal(typedEvent);
    commonDispatchTail_1(typedEvent);
    afterEvent();
  }
  //EVENT DISPATCH - END
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(multiEventPathRootNode_11, "multiEventPathRootNode_11");
  }
  ...
  private void afterEvent() {
    ...
    isDirty_multiEventPathRootNode_11 = false;
  }
  ...
  public BooleanSupplier dirtySupplier(Object node) {
    if (dirtyFlagSupplierMap.isEmpty()) {
      ...
      dirtyFlagSupplierMap.put(multiEventPathRootNode_11, () -> isDirty_multiEventPathRootNode_11);
    }
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      ...
      dirtyFlagUpdateMap.put(
          multiEventPathRootNode_11, (b) -> isDirty_multiEventPathRootNode_11 = b);
    }
  ...
  private boolean guardCheck_multiEventPathNode_10() {
    return isDirty_multiEventPathRootNode_11;
  }
