...
public class ShortChain5Processor
  ...
  private final transient ShortChainRootNode shortChainRootNode_6 = new ShortChainRootNode();
  ...
  private boolean isDirty_shortChainRootNode_6 = false;
  ...
  public ShortChain5Processor(Map<Object, Object> contextMap) {
    ...
    shortChainNode_5.setUpstream1(shortChainRootNode_6);
    shortChainNode_5.value = 0.0;
    shortChainNode_5.upstream1 = shortChainRootNode_6;
    shortChainRootNode_6.value = 0.0;
  ...
  public void handleEvent(ShortChainEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_shortChainRootNode_6 = shortChainRootNode_6.processChain(typedEvent);
  ...
  public boolean processChain(com.telamin.fluxtion.test.performance.events.ShortChainEvent arg0) {
    ...
    isDirty_shortChainRootNode_6 = shortChainRootNode_6.processChain(arg0);
    if (guardCheck_shortChainNode_5()) {
      isDirty_shortChainNode_5 = shortChainNode_5.onUpstream();
    }
    if (guardCheck_shortChainNode_4()) {
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(shortChainRootNode_6, "shortChainRootNode_6");
  ...
  private void afterEvent() {
    ...
    isDirty_shortChainRootNode_6 = false;
  }
  ...
  public BooleanSupplier dirtySupplier(Object node) {
    if (dirtyFlagSupplierMap.isEmpty()) {
      ...
      dirtyFlagSupplierMap.put(shortChainRootNode_6, () -> isDirty_shortChainRootNode_6);
    }
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      ...
      dirtyFlagUpdateMap.put(shortChainRootNode_6, (b) -> isDirty_shortChainRootNode_6 = b);
    }
  ...
  private boolean guardCheck_shortChainNode_5() {
    return isDirty_shortChainRootNode_6;
  }
