...
public class IntermediateHandlers5Processor
    implements CloneableDataFlow<IntermediateHandlers5Processor>,
        /*--- @ExportService start ---*/
  ...
  private final transient IntermediateHandlersRootNode intermediateHandlersRootNode_6 =
  ...
  private boolean isDirty_intermediateHandlersRootNode_6 = false;
  ...
  public IntermediateHandlers5Processor(Map<Object, Object> contextMap) {
    if (context != null) {
    ...
    intermediateHandlersNode_5.setUpstream1(intermediateHandlersRootNode_6);
    intermediateHandlersNode_5.value = 0.0;
    intermediateHandlersNode_5.upstream1 = intermediateHandlersRootNode_6;
    sink.setUpstream1(intermediateHandlersNode_1);
    sink.upstream1 = intermediateHandlersNode_1;
    sink.value = 0.0;
    intermediateHandlersRootNode_6.value = 0.0;
    //node auditors
  ...
  public IntermediateHandlers5Processor() {
    this(null);
  }
  ...
  public void handleEvent(MarketDataEvent typedEvent) {
    auditEvent(typedEvent);
    //Default, no filter methods
    isDirty_intermediateHandlersRootNode_6 =
        intermediateHandlersRootNode_6.onMarketData(typedEvent);
  ...
  public void handleEvent(TradeSignalEvent typedEvent) {
    ...
    //Default, no filter methods
    isDirty_intermediateHandlersRootNode_6 =
        intermediateHandlersRootNode_6.onTradeSignal(typedEvent);
    commonDispatchTail_1(typedEvent);
    afterEvent();
  }
  //EVENT DISPATCH - END
  ...
  private void initialiseAuditor(Auditor auditor) {
    ...
    auditor.nodeRegistered(intermediateHandlersRootNode_6, "intermediateHandlersRootNode_6");
  }
  ...
  private void afterEvent() {
    ...
    isDirty_intermediateHandlersRootNode_6 = false;
  }
  ...
  public BooleanSupplier dirtySupplier(Object node) {
    if (dirtyFlagSupplierMap.isEmpty()) {
      ...
      dirtyFlagSupplierMap.put(
          intermediateHandlersRootNode_6, () -> isDirty_intermediateHandlersRootNode_6);
    }
  ...
  public void setDirty(Object node, boolean dirtyFlag) {
    if (dirtyFlagUpdateMap.isEmpty()) {
      ...
      dirtyFlagUpdateMap.put(
          intermediateHandlersRootNode_6, (b) -> isDirty_intermediateHandlersRootNode_6 = b);
    }
  ...
  private boolean guardCheck_intermediateHandlersNode_5() {
    return isDirty_intermediateHandlersRootNode_6;
  }
  ...
  @Override
  public IntermediateHandlers5Processor newInstance() {
    return new IntermediateHandlers5Processor();
  }

  @Override
  public IntermediateHandlers5Processor newInstance(Map<Object, Object> contextMap) {
    return new IntermediateHandlers5Processor();
  }
